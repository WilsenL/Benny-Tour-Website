	...
	function sc_header_icon($attr){
		...
		if( !empty($image) || !empty($icon) || !empty($icon_html) ){
			$output .= '<div class="icon-wrapper">';
				...
				if( !empty($image) ){
 					$output .= '<img class="scale-with-grid" src="'. esc_url($image) .'" alt="">';
 				}elseif( !empty($icon) ){
			...
			if( !empty($dynamic_items) && is_iterable($dynamic_items) ){
				foreach ($dynamic_items as $d=>$di) {
					...
					if( $di['type'] == 'predefined' ){
						$output .= '<li data-uid="'.$di['uid'].'" class="uid-'.$di['uid'].'"><img src="'.get_template_directory_uri().'/images/payment-methods/'.$di['id'].'.svg" alt=""></li>';
					}else{
						$output .= '<li data-uid="'.$di['uid'].'" class="uid-'.$di['uid'].'"><img src="'.$di['url'].'" alt=""></li>';
					}
				}
			}else{
				$output .= '<li><img src="'.get_template_directory_uri().'/images/payment-methods/Mastercard.svg" alt=""></li>';
				$output .= '<li><img src="'.get_template_directory_uri().'/images/payment-methods/PayPal.svg" alt=""></li>';
				$output .= '<li><img src="'.get_template_directory_uri().'/images/payment-methods/ApplePay.svg" alt=""></li>';
			}
			...
			$output .= '<div class="mfn-divider-inner">';
				...
				if( 'label' == $addon && $label ){
					...
					$output .= '<span class="divider-addon divider-image">';
						$output .= '<img src="'. esc_url($image) .'" alt="'. esc_attr(mfn_get_attachment_data($image, 'alt')) .'"/>';
					$output .= '</span>';
